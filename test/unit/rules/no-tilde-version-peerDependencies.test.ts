import {lint, ruleType} from '../../../src/rules/no-tilde-version-peerDependencies';
import {Severity} from '../../../src/types/severity';

describe('no-tilde-version-peerDependencies Unit Tests', () => {
  ...
  describe('when package.json has node with an invalid value', () => {
    test('LintIssue object should be returned', () => {
      ...
      expect(response.lintId).toStrictEqual('no-tilde-version-peerDependencies');
