import {lint, ruleType} from '../../../src/rules/no-git-peerDependencies';
import {Severity} from '../../../src/types/severity';

describe('no-git-peerDependencies Unit Tests', () => {
  ...
  describe('when package.json has node with an invalid value', () => {
    describe('with github:user/repo', () => {
      test('LintIssue object should be returned', () => {
        ...
        expect(response.lintId).toStrictEqual('no-git-peerDependencies');
        expect(response.severity).toStrictEqual('error');
        expect(response.node).toStrictEqual('peerDependencies');
        expect(response.lintMessage).toStrictEqual(
          'You are using peerDependencies from git repository. Please use peerDependencies from npm. Invalid peerDependencies include: my-module',
        );
      });
    });
