import {lint, ruleType} from '../../../src/rules/prefer-caret-version-peerDependencies';
import {Severity} from '../../../src/types/severity';

describe('prefer-caret-version-peerDependencies Unit Tests', () => {
  ...
  describe('when package.json has node with an invalid value', () => {
    test('LintIssue object should be returned', () => {
      ...
      expect(response.lintId).toStrictEqual('prefer-caret-version-peerDependencies');
